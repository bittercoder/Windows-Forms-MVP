...
namespace System.Linq
{
    public static partial class Enumerable
    {
        ...
        private static TSource Single<TSource>(this IEnumerable<TSource> source, Func<TSource, bool> predicate,
                                               bool orDefault)
        {
            ...
            foreach (TSource element in source)
                ...
                {
                    if (match)
                        throw new InvalidOperationException("Enumerable contains more than one matching element");
                    match = true;
                    answer = element;
                }
        ...
        private static TSource First<TSource>(this IEnumerable<TSource> source, Func<TSource, bool> predicate,
                                              bool orDefault)
        {
            if (source == null) throw new ArgumentNullException("source");
            if (predicate == null) throw new ArgumentNullException("predicate");
        ...
        private static TSource Last<TSource>(this IEnumerable<TSource> source, Func<TSource, bool> predicate,
                                             bool orDefault)
        {
            if (source == null) throw new ArgumentNullException("source");
            if (predicate == null) throw new ArgumentNullException("predicate");
        ...
        private static TSource ElementAt<TSource>(this IEnumerable<TSource> source, int index, bool orDefault)
        {
            if (source == null) throw new ArgumentNullException("source");
